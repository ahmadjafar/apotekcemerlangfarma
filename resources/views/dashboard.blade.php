                ...
                <div class="bg-white-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-3">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="#">SUCCESS </a></div>
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="#">ON DELIVERY </a></div>
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            <img src="{{ asset ('img/transaction.svg') }}" alt="" >
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="#">CANCELLED </a></div>
