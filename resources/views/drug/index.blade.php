                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-6 py-4 text-center">
                            <a href="{{route('drug.edit', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 mx-2 rounded">
                                Edit
                            </a>

                            <form action="{{ route('drug.destroy', $item->id) }}" method="POST" class="inline-block">
